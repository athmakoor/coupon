...
public interface ReferralBonusMappingRepository extends PagingAndSortingRepository<ReferralBonusMappingEntity, Integer> {
    ...
    List<ReferralBonusMappingEntity> findAllValidByUserType(@Param("currentDate") Date date, @Param("cartValue") Double cartValue, @Param("userType")ReferralUserType userType);
}
